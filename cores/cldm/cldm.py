...
from cores.ldm.modules.diffusionmodules.util import (
    timestep_embedding,
)

from cores.ldm.modules.attention import SpatialTransformer
from cores.ldm.modules.diffusionmodules.openaimodel import (
    UNetModel,
    TimestepEmbedSequential,
    ResBlock,
    Downsample,
)
from cores.ldm.util import exists
from cores.cldm.control_types import UNION_CONTROLNET_TYPES
...
class ControlNet(nn.Module):
    def __init__(
        ...
        device=None,
        operations=cores.ops.disable_weight_init,
        **kwargs,
    ):
        super().__init__()
