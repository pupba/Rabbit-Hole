...
from cores.weight_adapter.base import (
    WeightAdapterBase,
    weight_decompose,
    pad_tensor_to_shape,
)
...
class LoRAAdapter(WeightAdapterBase):
    ...
    def calculate_weight(
        ...
        v = self.weights
        mat1 = cores.model_management_utils.cast_to_device(
            v[0], weight.device, intermediate_dtype
        )
        mat2 = cores.model_management_utils.cast_to_device(
        ...
        if v[3] is not None:
            ...
            mat3 = cores.model_management_utils.cast_to_device(
