...
from cores.weight_adapter.base import WeightAdapterBase, weight_decompose
...
class BOFTAdapter(WeightAdapterBase):
    ...
    def calculate_weight(
        ...
        blocks = cores.model_management_utils.cast_cores.weight_adapterto_device(
            blocks, weight.device, intermediate_dtype
        )
        if rescale is not None:
            rescale = cores.model_management_utils.cast_cores.weight_adapterto_device(
        ...
        try:
            ...
            lora_diff = inp - org
            lora_diff = cores.model_management_utils.cast_cores.weight_adapterto_device(
