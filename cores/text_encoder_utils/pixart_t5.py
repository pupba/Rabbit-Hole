...
from cores.text_encoder_utils.sd1_clip import gen_empty_tokens

from transformers import T5TokenizerFast


class T5XXLModel(cores.text_encoder_utils.sd3_clip.T5XXLModel):
