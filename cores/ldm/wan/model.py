...
from cores.ldm.flux.layers import EmbedND
from cores.ldm.flux.math import apply_rope
...
class WanAttentionBlock(nn.Module):
    ...
    def forward(
        ...
        e = (
            cores.model_management_utils.cast_to(
...
class WanModel(torch.nn.Module):
    ...
    def forward(
        self, x, timestep, context, clip_fea=None, transformer_options={}, **kwargs
    ):
        bs, c, t, h, w = x.shape
        x = cores.ldm.common_dit.pad_to_patch_size(x, self.patch_size)
