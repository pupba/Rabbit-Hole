...
from cores.ldm.lightricks.model import TimestepEmbedding, Timesteps
import torch.nn.functional as F

from cores.ldm.flux.math import apply_rope, rope
from cores.ldm.flux.layers import LastLayer
...
class HiDreamImageTransformer2DModel(nn.Module):
    ...
    def forward(
        ...
        hidden_states = cores.ldm.common_dit.pad_to_patch_size(
