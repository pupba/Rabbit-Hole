...
from cores.ldm.flux.layers import timestep_embedding

from cores.ldm.flux.model import Flux
...
class ControlNetFlux(Flux):
    ...
    def forward(self, x, timesteps, context, y, guidance=None, hint=None, **kwargs):
        patch_size = 2
        if self.latent_input:
            hint = cores.ldm.common_dit.pad_to_patch_size(
        ...
        bs, c, h, w = x.shape
        x = cores.ldm.common_dit.pad_to_patch_size(x, (patch_size, patch_size))
