...
from cores.ldm.modules.distributions.distributions import DiagonalGaussianDistribution

from cores.ldm.util import get_obj_from_str, instantiate_from_config
from cores.ldm.modules.ema import LitEma
import cores.ops
...
class AutoencodingEngineLegacy(AutoencodingEngine):
    def __init__(self, embed_dim: int, **kwargs):
        ...
        if ddconfig.get("conv3d", False):
            conv_op = cores.ops.disable_weight_init.Conv3d
        else:
            conv_op = cores.ops.disable_weight_init.Conv2d
