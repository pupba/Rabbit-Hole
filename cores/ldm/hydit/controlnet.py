...
from cores.ldm.modules.diffusionmodules.mmdit import (
    TimestepEmbedder,
    PatchEmbed,
)
...
from cores.ldm.hydit.models import HunYuanDiTBlock, calc_rope
...
class HunYuanControlNet(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.norm = norm
        self.dtype = dtype
        self.latent_format = cores.latent_formats.SDXL
