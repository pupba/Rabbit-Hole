...
import cores.ops
from cores.ldm.modules.diffusionmodules.mmdit import Mlp, TimestepEmbedder, PatchEmbed
from cores.ldm.modules.diffusionmodules.util import timestep_embedding
from torch.utils import checkpoint

from cores.ldm.hydit.attn_layers import Attention, CrossAttention
from cores.ldm.hydit.poolers import AttentionPool
from cores.ldm.hydit.posemb_layers import (
    get_2d_rotary_pos_embed,
    get_fill_resize_and_crop,
)
...
class HunYuanDiT(nn.Module):
    ...
    def forward(
        ...
        padding = cores.ops.cast_to_input(self.text_embedding_padding, text_states)
        ...
        _, _, oh, ow = x.shape
        th, tw = (oh + (self.patch_size // 2)) // self.patch_size, (
