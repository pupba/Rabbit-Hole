...
import cores.text_encoder_utils.t5
...
from cores import supported_models_base_utils
from cores import latent_formats

from cores import diffusers_convert


class SD15(supported_models_base_utils.BASE):
    unet_config = {
        "context_dim": 768,
        "model_channels": 320,
    ...
    def process_clip_state_dict(self, state_dict):
        ...
        state_dict = cores.utils.state_dict_prefix_replace(
    ...
    def process_clip_state_dict_for_saving(self, state_dict):
        ...
        return cores.utils.state_dict_prefix_replace(state_dict, replace_prefix)
...
class SD20(supported_models_base_utils.BASE):
    unet_config = {
        "context_dim": 1024,
        "model_channels": 320,
    ...
    def process_clip_state_dict(self, state_dict):
        ...
        state_dict = cores.utils.clip_text_transformers_convert(
    ...
    def process_clip_state_dict_for_saving(self, state_dict):
        ...
        state_dict = cores.utils.state_dict_prefix_replace(state_dict, replace_prefix)
...
class SDXLRefiner(supported_models_base_utils.BASE):
    unet_config = {
        "model_channels": 384,
        "use_linear_in_transformer": True,
        "context_dim": 1280,
    ...
    def process_clip_state_dict(self, state_dict):
        ...
        state_dict = cores.utils.state_dict_key_replace(state_dict, keys_to_replace)
        return state_dict
    ...
    def process_clip_state_dict_for_saving(self, state_dict):
        ...
        state_dict_g = cores.utils.state_dict_prefix_replace(
            state_dict_g, replace_prefix
        )
        return state_dict_g
...
class SDXL(supported_models_base_utils.BASE):
    unet_config = {
        "model_channels": 320,
        "use_linear_in_transformer": True,
...
class SVD_img2vid(supported_models_base_utils.BASE):
    unet_config = {
        "model_channels": 320,
        "in_channels": 8,
        "use_linear_in_transformer": True,
...
class Stable_Zero123(supported_models_base_utils.BASE):
    unet_config = {
        "context_dim": 768,
        "model_channels": 320,
        "use_linear_in_transformer": False,
...
class Stable_Cascade_C(supported_models_base_utils.BASE):
    unet_config = {
...
class SD3(supported_models_base_utils.BASE):
    unet_config = {
        "in_channels": 16,
...
class StableAudio(supported_models_base_utils.BASE):
    unet_config = {
        "audio_model": "dit1.0",
    }
    ...
    def get_model(self, state_dict, prefix="", device=None):
        seconds_start_sd = cores.utils.state_dict_prefix_replace(
            state_dict,
            {"conditioner.conditioners.seconds_start.": ""},
            filter_keys=True,
        )
        seconds_total_sd = cores.utils.state_dict_prefix_replace(
            state_dict,
...
class AuraFlow(supported_models_base_utils.BASE):
    unet_config = {
        "cond_seq_dim": 2048,
    }
...
class PixArtAlpha(supported_models_base_utils.BASE):
    unet_config = {
...
class HunyuanDiT(supported_models_base_utils.BASE):
    unet_config = {
        "image_model": "hydit",
    }
...
class Flux(supported_models_base_utils.BASE):
    unet_config = {
        "image_model": "flux",
        "guidance_embed": True,
    }
...
class GenmoMochi(supported_models_base_utils.BASE):
    unet_config = {
...
class LTXV(supported_models_base_utils.BASE):
    unet_config = {
        "image_model": "ltxv",
    }
...
class HunyuanVideo(supported_models_base_utils.BASE):
    unet_config = {
...
class CosmosT2V(supported_models_base_utils.BASE):
    unet_config = {
        "image_model": "cosmos",
        "in_channels": 16,
    }
...
class Lumina2(supported_models_base_utils.BASE):
    unet_config = {
        "image_model": "lumina2",
    }
...
class WAN21_T2V(supported_models_base_utils.BASE):
    unet_config = {
        "image_model": "wan2.1",
        "model_type": "t2v",
    }
...
class Hunyuan3Dv2(supported_models_base_utils.BASE):
    unet_config = {
...
class HiDream(supported_models_base_utils.BASE):
    unet_config = {
        "image_model": "hidream",
    }
...
class Chroma(supported_models_base_utils.BASE):
    unet_config = {
        "image_model": "chroma",
    }
...
class ACEStep(supported_models_base_utils.BASE):
    unet_config = {
        "audio_model": "ace",
    }
    ...
    latent_format = cores.latent_formats.ACEAudio
